...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VOLUNTEEROP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VOLUNTEEROP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VOLUNTEEROP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VOLUNTEEROP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VOLUNTEEROP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VOLUNTEEROP actions', async () => {
      const arg = 42666;
