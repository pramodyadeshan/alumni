...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './donation.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DONATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DONATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DONATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DONATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DONATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DONATION actions', async () => {
      const arg = 42666;
